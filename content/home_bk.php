...
<body>
<h3 align="center">Selamat Datang Siswa/i SMK Negeri 1 Binangun</h3>
<div class="well">
...
<fieldset>
  ...
  <div class="form-group">
      <label for="noujian" class="col-lg-2 control-label">Tanggal Lahir</label>
      <div class="col-lg-10">
        <input type="text" class="form-control" name="tgllhr" placeholder="10-04-1997" size="10">
      </div>
  </div>
